...
Task 12: complete (commit c3b8843 — auto-sync scheduler with per-user in-flight guard, findAll on UserService, POST /sync/run endpoint)
Task 13: complete (commit f11a453 — Dockerfile build order fixed, docker-compose DATA_PATH added, README written; local prod build verified)
