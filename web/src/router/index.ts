  ...
  routes: [
    { path: '/login', component: Login },
    {
      ...
      children: [
        ...
        { path: 'activities/def/new', component: () => import('../views/ActivityDefForm.vue'), meta: { title: '新建活动' } },
        { path: 'activities/def/:id/edit', component: () => import('../views/ActivityDefForm.vue'), meta: { title: '编辑活动' } },
        { path: 'vehicles', component: () => import('../views/Vehicles.vue'), meta: { title: '车辆管理' } },
        { path: 'attachments', component: () => import('../views/Attachments.vue'), meta: { title: '附件' } },
        { path: 'debts', component: () => import('../views/Debts.vue'), meta: { title: '债务' } },
        { path: 'debts/new', component: () => import('../views/DebtForm.vue'), meta: { title: '新增债务' } },
        { path: 'debts/:id', component: () => import('../views/DebtDetail.vue'), meta: { title: '债务详情' } },
        { path: 'debts/:id/payment', component: () => import('../views/DebtPayment.vue'), meta: { title: '记一笔' } },
        { path: 'fuel-records', component: () => import('../views/FuelRecords.vue'), meta: { title: '加油记录' } },
        { path: 'fuel-records/new', component: () => import('../views/FuelRecordForm.vue'), meta: { title: '新建加油' } },
        { path: 'fuel-records/:id/edit', component: () => import('../views/FuelRecordForm.vue'), meta: { title: '编辑加油' } },
